 ...
 */
class Wpza_Maintenance_Development_Mode {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wpza_Maintenance_Development_Mode_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wpza_Maintenance_Development_Mode_Loader. Orchestrates the hooks of the plugin.
	 * - Wpza_Maintenance_Development_Mode_i18n. Defines internationalization functionality.
	 * - Wpza_Maintenance_Development_Mode_Admin. Defines all hooks for the admin area.
	 * - Wpza_Maintenance_Development_Mode_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wpza_Maintenance_Development_Mode_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wpza_Maintenance_Development_Mode_Loader    Orchestrates the hooks of the plugin.
	 */
